...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BOOL isToday=[[NSCalendar currentCalendar]isDateInToday: [NSDate dateWithTimeIntervalSince1970:recent.lastMessage.timestamp] ];
    if (isToday) {
        cell.timeLabel.text = [NSString dateWithTimeInterval:recent.lastMessage.timestamp formatter:@"HH:mm"] ;
    } else {
        cell.timeLabel.text =[NSString dateWithTimeInterval:recent.lastMessage.timestamp formatter:@"yyyy-MM-dd"] ;
    }
