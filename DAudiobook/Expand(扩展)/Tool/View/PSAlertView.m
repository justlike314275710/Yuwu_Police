...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        UIFont *titleFont = AppFont(15);
        UIFont *contentFont =AppFont(13);
        CGFloat width = CGRectGetWidth(self.frame);
        CGFloat contentWidth = width - 2 * horSideSpace;
       // UIColor *titleColor = UIColorFromHexadecimalRGB(0x383838);
        UIColor *titleColor = [UIColor blackColor];
        UIColor *otherColor =UIColorHex(0x383838);
        //UIColorFromHexadecimalRGB(0x383838);
        ...
        horiLine.backgroundColor =UIColorHex(0xe4e4e4); //UIColorFromHexadecimalRGB(0xe4e4e4);
        ...
        for (NSInteger i = 0; i < bCount; i ++) {
            ...
            [titleButton.titleLabel setFont:AppFont(13)];
           // [titleButton setTitleColor:UIColorFromHexadecimalRGB(0x383838) forState:UIControlStateNormal];
            [titleButton setTitleColor:AppColor(100, 140, 214) forState:UIControlStateNormal];
            ...
            if (i > 0) {
                ...
                verLine.backgroundColor =UIColorHex(0xe4e4e4);
                //UIColorFromHexadecimalRGB(0xe4e4e4);
