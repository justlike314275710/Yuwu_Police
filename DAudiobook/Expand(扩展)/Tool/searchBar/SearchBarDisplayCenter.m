...
-(void)layoutSubviews
{
    ...
    _searchField.frame = CGRectMake(16.0 + 14.0, 0, containerW - (16.0 + 14.0) - 16.0, 30.0);
    _searchField.font = [UIFont systemFontOfSize:13.0];
    _searchField.returnKeyType = UIReturnKeySearch;
    //绘制圆角 要设置的圆角 使用“|”来组合
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:_searchField.bounds byRoundingCorners:UIRectCornerTopRight | UIRectCornerBottomRight cornerRadii:CGSizeMake(30.0 / 2.0, 30.0 / 2.0)];
    ...
    CGSize needSize = [placeHolderStr boundingRectWithSize:CGSizeMake(MAXFLOAT, 30.0) options:NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:13.0]} context:nil].size;
    //计算放大镜和提示语所占据宽度
