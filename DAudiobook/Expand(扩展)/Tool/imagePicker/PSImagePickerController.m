...
- (void)viewDidLoad {
    ...
    UIView *bgNavView = [[UIView alloc] initWithFrame:CGRectMake(0,0,SCREEN_WIDTH,kTopHeight)];
...
//    self.navigationItem.leftBarButtonItem = leftItem;
    ...
    comfirmButton.frame = CGRectMake(SCREEN_WIDTH-80,(kTopHeight-44)/2+kStatusBarHeight/2, 60, 44);
