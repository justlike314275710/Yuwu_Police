...
- (void)loadImage {
    ...
    // 开始加载
    weak_self;
    #warning TODO LBPhone 下载无用
   /*
    self.opreation =[[SDWebImageDownloader sharedDownloader] downloadImageWithURL:self.url options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
...
//    }
//    ;
//     [[SDWebImageManager sharedManager] loadImageWithURL: options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
