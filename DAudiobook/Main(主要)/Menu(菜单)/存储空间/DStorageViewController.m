...
@interface DStorageViewController ()
...
@implementation DStorageViewController
...
- (void)p_refreshUI {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        DStorageLogic*logic=[[DStorageLogic alloc]init];
        self.allStorage.hidden = NO;
        self.allStorage.text = logic.allStorage;
        self.calcuLab.text = logic.usedStorage;
