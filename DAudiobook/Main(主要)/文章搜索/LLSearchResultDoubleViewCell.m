...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(kSpace, CGRectGetMaxY(_leftTitle.frame) + 9, SCREEN_WIDTH - kSpace * 2, 1)];
        line.backgroundColor =AppColor(241, 241, 241);
...
{
    if (!_leftImage) {
        self.leftImage = [[UIImageView alloc] initWithFrame:CGRectMake(kSpace, 10, SCREEN_WIDTH, SCREEN_WIDTH)];
...
{
    if (!_leftTitle) {
        self.leftTitle = [[UILabel alloc] initWithFrame:CGRectMake(kSpace, CGRectGetMaxY(_leftImage.frame) + 10, SCREEN_WIDTH, 20)];
...
{
    if (!_rightImage) {
        self.rightImage = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - kSpace - KWidth, 10, KWidth, KWidth)];
...
{
    if (!_rightTitle) {
        self.rightTitle = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_rightImage.frame), CGRectGetMaxY(_rightImage.frame) + 10, SCREEN_WIDTH, 20)];
